...
class CalendarList extends Component {
  ...
  getItemLayout(data, index) {
    return {
      length: this.props.horizontal ? this.props.calendarWidth : 520, 
      offset: (this.props.horizontal ? this.props.calendarWidth : 520) * index, index
    };
  }
